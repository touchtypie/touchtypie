...
var BubbleController = function () {
    ...
    new Binding({
        ...
        function(event, _this, binding) {
            ...
            _student.amend_num_total += virtue.result.amend_num_new;
            _student.amend_num_total_percentage = _student.amend_num_total == 0 ? 0.00 : (_student.amend_num_total / _student.shot_num_total * 100).toFixed(2)
            if (virtue.completed) {
                // Set hits value
